	...
	<div class="theme-panel-content" data-scrollbar="true" data-height="100%">
		...
		<div class="row mt-10px">
			<div class="col-8 control-label text-dark fw-bold">
				<div class="d-flex">Dark Mode <span class="badge bg-primary ms-1 py-2px position-relative d-flex align-items-center">NEW</span></div>
				<div class="lh-14">
		...
		<div class="row mt-10px align-items-center">
			<div class="col-8 control-label text-dark fw-bold">Gradient Enabled</div>
			<div class="col-4 d-flex">
				<div class="form-check form-switch ms-auto mb-0">
		...
		<div class="row mt-10px align-items-center">
			<div class="col-8 control-label text-body fw-bold d-flex">RTL Enabled <span class="badge bg-primary ms-1 position-relative d-flex align-items-center">NEW</span></div>
			<div class="col-4 d-flex">
				<div class="form-check form-switch ms-auto mb-0">
