			...
			<div class="file-manager h-100" id="fileManager">
				...
				<div class="file-manager-container">
					...
					<div class="file-manager-content d-flex flex-column">
						<div class="mb-0 d-flex text-nowrap p-3 border-bottom flex-wrap gap-2">
							<button type="button" class="btn btn-sm btn-white px-2"><i class="fa fa-fw fa-home"></i></button>
							<button type="button" class="btn btn-sm btn-white" disabled><i class="fa fa-fw fa-arrow-turn-up ms-n1"></i>  Up One Level</button>
							...
							<button type="button" class="btn btn-sm btn-white px-2"><i class="fa fa-fw fa-arrows-rotate"></i></button>
