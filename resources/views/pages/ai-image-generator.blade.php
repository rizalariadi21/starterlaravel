		...
		<div class="position-relative p-3 p-md-4 bg-gradient-135 bg-gradient-from-black bg-gradient-to-transparent">
			...
			<div class="position-relative h-100 w-100 mb-5 pb-3 mx-auto d-flex" style="max-width: 520px;">
				...
				<div class="dropdown me-2 ms-auto">
					<button type="button" data-bs-toggle="dropdown" class="btn bg-black bg-opacity-50 bg-blur-3 rounded-10px fw-bolder border-0"><i class="fa fa-fw fa-globe me-2px"></i> <span id="aiRatioText">Ratio</span> <i class="fa fa-chevron-down fa-fw opacity-50 ms-1"></i></button>
				...
				<div class="dropdown">
					<button type="button" data-bs-toggle="dropdown" class="btn bg-black bg-opacity-50 bg-blur-3 rounded-10px fw-bolder border-0"><i class="fa fa-fw fa-palette me-2px"></i> <span id="aiStyleText">Style</span> <i class="fa fa-chevron-down fa-fw opacity-50 ms-1"></i></button>
					<div class="dropdown-menu dropdown-menu-end rounded-3">
