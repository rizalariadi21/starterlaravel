...
Route::get('/starter', 'MainController@starter')->name('starter');

Route::get('/ai/chat', 'MainController@aiChat')->name('ai-chat');
Route::get('/ai/image-generator', 'MainController@aiImageGenerator')->name('ai-image-generator');
